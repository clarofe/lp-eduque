...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-preto-impacto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 max-w-3xl order-1 lg:order-2">
            ...
            <div className="space-y-4 text-branco-classico text-base lg:text-lg leading-relaxed">
              ...
              <p>
                <span className="font-bold">Como aplicar (Passo a Passo):</span> Um método prático que te leva do zero à sua primeira atividade gamificada, adaptável para qualquer disciplina e turma.
              </p>
              <p>
                <span className="font-bold">Dicas e ferramentas essenciais:</span> Descubra truques e ferramentas para economizar tempo e potencializar suas aulas.
              </p>
              <p>
                <span className="font-bold">Casos reais para se inspirar:</span> Veja exemplos práticos de como usar a gamificação para transformar suas aulas e motivar os alunos.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Form Section */}
      <div className="container mx-auto px-6 lg:px-24 py-16">
        <div className="bg-branco-classico rounded-2xl p-8 lg:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) => handleInputChange('agreeToEmails', e.target.checked)}
                ...
                <p className="text-preto-impacto text-xs leading-relaxed">
                  Respeitamos sua privacidade. Seus dados estão seguros conosco e você não receberá spam.
                </p>
